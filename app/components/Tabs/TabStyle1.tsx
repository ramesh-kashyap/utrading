...
const TabStyle1 = ({tabMenu, setActiveTab, activeTab, colors, size, color, activeIndex} : Props) => {
    ...
    const tabWidth =  (size === 'sm' ? (SIZES.width - 38 > SIZES.container ? SIZES.container - 38: SIZES.width - 38 ) : (SIZES.width - 42 > SIZES.container ? SIZES.container - 42 : SIZES.width - 42)) / 2;
